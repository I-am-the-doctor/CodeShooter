...
/**
 * Class that holds a PointLight with parameters
 * (position, color, intensity, attenuation behaviour)
 *
...
public class PointLight
{
   ...
   /**
    * Helper class which describes the behaviour of a light from a certain distance.
    */
